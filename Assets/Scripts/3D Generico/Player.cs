...
public class Player : MonoBehaviour
{
    ...
    {   
        ...
        bool castHit = VicGenLib.Logic.RayCasts.CustomCastInfo(this.gameObject, Vector3.forward, new Vector3(0,0,0.0f), true, 2f, out raycastHit);
        ...
        VicGenLib.Controllers.MovBase.SimplePlayerMovementRB(this.gameObject, ForceMode.VelocityChange, 0.5f);
